...
### المرحلة 3: تحسين الصفحات واللوحات (قيد التنفيذ بالتتابع)
1. **المرحلة الأولى:** تلميع وبنود تفاصيل لوحات الأدوار (المعلم `/teacher/*`، ولي الأمر `/parent/*`، والطالب `/student/*`).
2. **المرحلة الثانية:** التحقق من تفاصيل صفحات الإدارة المدرسية المساعدة (الرسوم `/school/fees`، النقل `/school/transport`، والإعلانات).
3. **المرحلة الثالثة:** التدقيق والفحص النهائي (تشغيل الاختبارات وتحديث التقارير).
