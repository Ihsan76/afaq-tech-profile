...
- **البنية التحتية والـ CI**: دمج Celery في `backend/requirements.txt`، إضافة `.gitleaksignore` لتجاوز تنبيهات `render.yaml`، السماح بـ 404 لـ QA EXTRA_ROUTES، وإصلاح كافة تحذيرات ruff و eslint و lint عبر الباكند والفرونت إند.
